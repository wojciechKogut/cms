...
<body class="fixed-nav sticky-footer bg-dark" id="page-top ">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
        ...
        <a style="border-radius: 25px; border: 1px solid white; text-align: center;" class="navbar-brand" href="#"><?php echo (isset($_SESSION['user_name'])) ? " " . $_SESSION['user_name'] : "" ?></a>
            ...
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" data-parent="#exampleAccordion" title="Components">
                    ...
                    <ul class="collapse show" id="posts">
                        <li>
                            <a class="" href="<?php echo ROOT ?>posts">View all posts</a>
                        </li>
                        <li>
                            <a class="" href="<?php echo ROOT ?>posts/add">Add new post</a>
                        </li>
                    </ul>
                </li>
            ...
            <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
                ...
                <li class="nav-item" data-toggle="tooltip"  data-parent="#exampleAccordion"  data-placement="right" title="Category">
                    ...
                    <ul class="collapse show" id="category">
                        <li>
                            <a class="" href="<?php echo ROOT ?>categories">View categories</a>
                        </li>
                        <li>
                            <a class="" href="<?php echo ROOT ?>categories/add">Add new category</a>
                        </li> 
                    </ul>
                ...
                <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Users" data-parent="#exampleAccordion">
                    ...
                    <ul class="collapse show" id="users">
                        <li>
                            <a class="" href="<?php echo ROOT ?>users">View all users</a>
                        </li>
                        <li>
                            <a class="" href="<?php echo ROOT ?>users/add">Add new user</a>
                        </li>
                    </ul>
                </li>
