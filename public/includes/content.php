...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="col-md-12 col-lg-12 col-md-12">
            ...
            <div class="card mx-auto" style="border:none">
                <div class="col-md-12 p-0">                  
                        ...
                        <div class="col-lg-12 col-xl-4 p-0" id="btnContainer">
        ...
        <?php endif; ?>
          <?php foreach ($posts as $post) : ?> 
                <div class="col-md-1 col-lg-1 col-sm-1 my-5" style="position:relative; height:235px;">
                ...
                <div class="card mt-5 mb-5" style="box-shadow: 0.2px 0.5px">
                    <div class="card-body" style="background-color:#FBFBFB">
                       <h4 class="card-title"><a href="<?php echo ROOT . "users/post/" . $post->slug ?>"><?php echo $post->post_title; ?></h4></a>
                        ...
                        <p><span class="glyphicon glyphicon-time"> Posted  <?php echo $post->created_at->diffForHumans() ?></span>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12 col-lg-2 mr-auto p-0" style="background-color: #fff; padding-bottom: 7em;">
          ...
          <!-- Side Widget -->
           <div class="card my-5" style="border-radius: 0">
                      ...
                      <div class="col-md-12" style="margin:0; padding:0 1.5rem;">
                          <ul class="list-unstyled mb-0">
                              <?php foreach ($recent as $post) : ?>
                                <li class="list-group-item" style="border-left: 3px solid #006699; width:100%;border-radius:0">
