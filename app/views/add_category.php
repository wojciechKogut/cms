    ...
    <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
            <form role="form" action="<?php echo ROOT ?>categories/add" id="addCategory" method="post" >
                ...
                <label>Add category</label><i class="required-star">*</i>
                <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 2em;">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="form-group" style="float:left">
                          ...
                          <div style="color:#FF3366"><?php echo $form->error["cat_title"] ?></div>
                      </div>
                      <div class="col-md-6 col-sm-12 col-xs-12">
                          <button class="btn btn-primary ml-4" style="float:left;" type="submit" name="add_cat">Apply</button>
                      </div>  
                  </div>
                </div>
