...
<div class="content-wrapper">
    <div class="container-fluid">
        ...
        <div class="col-md-7 col-lg-6 ml-auto" style="background-color:#fff;">
            <hr>
          <!-- Blog Post -->
          <?php  if($count_rows == 0)  echo "<div class='alert alert-info'><b>No posts available<a href='".ROOT."'> See other posts</a></b></div>"; ?>
          <div class="col-md-12">
          ...
          <div class="card mt-5 mb-5" style="box-shadow: 0.2px 0.5px">
             ...
             <h4 class="card-title"><a href="<?php echo ROOT."users/post/".$post->slug ?>"><?php echo $post["post_title"];  ?></h4></a>
               ...
               <p class="text-justify"><?php echo strip_tags(html_entity_decode(truncate($post->post_content))); ?></p>
          ...
          <nav aria-label="Page navigation example"> 
              ...
              <ul class="pagination mx-auto">
                    ...
                    <?php for($i=1; $i<= $pagination->count ; $i++): ?>
                          <li class='page-item <?php echo $pagination->current_page == $i ? "active" : "" ?>'><a class='page-link' href="<?php echo ROOT."posts/post_cat/$id/$i" ?>"><?php echo $i ?></a></li>
                    <?php endfor; ?> 
